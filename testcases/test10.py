...
def test(cmd):
    ...
    time.sleep(0.3)
    os.system("./testclient localhost 2010 /testdata/file-sff-medium.txt > %s &" % file2);
    time.sleep(0.3)
    os.system("./testclient localhost 2010 /testdata/file-sff-small.txt > %s &" % file3);
    ...
    count3 = util.get_stat(file3, "Stat-thread-count")
    ...
    if cmd.find("SFF") > 0:
        if count1 == 4 and count2 == 3 and count3 == 2:
            ...
            util.error("Ouchs! Incorrect Stat-thread-count."
                       "Expected count1 = 3 and count2 = 3 and count3 == 2")

    if cmd.find("FIFO") > 0:
        if count1 == 2 and count2 == 3 and count3 == 4:
            util.good("your Stat-thread-count is corect")
        else:
            util.error("Ouchs! Incorrect Stat-thread-count!"
                       "Expected count1 == 2 and count2 ==3 and count3 == 4")
...
test("./server 2010 1 5 SFF")
test("./server 2010 1 5 FIFO")
